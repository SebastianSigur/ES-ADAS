...
def get_json_response_from_gpt(
    ...
    json_dict = json.loads(content) # double-quote vs single quote caused issues in some agents
...
def search(args):
    ...
    for n in range(start, args.n_generation):
        ...
        try:
            ...
            mutated_solution = get_json_response_from_gpt_reflect(msg_list)
            if 'code' in mutated_solution:
                if 'reflection' in mutated_solution:
                    next_solution['reflection'] = mutated_solution['reflection']
...
if __name__ == "__main__":
    ...
    parser.add_argument('--expr_name', type=str, default="task_mutator_test11_mgsm_openai_gemini_results")
