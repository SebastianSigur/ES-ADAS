...
from drop_prompt import get_init_archive, get_prompt, get_reflexion_prompt, get_task_mutated_instruction, get_prompt_mutated, TASK_MUTATOR_PROMPTS as INITIAL_TASK_MUTATOR_PROMPTS, get_initial_task_mutators
...
if __name__ == "__main__":
    ...
    parser.add_argument('--max_workers', type=int, default=24) # 24
    parser.add_argument('--debug', action='store_true', default=True)
    parser.add_argument('--save_dir', type=str, default='results/')
    parser.add_argument('--expr_name', type=str, default="drop_openai_gemini_task_mutator_experiment_3_run_3__rerun_results")
