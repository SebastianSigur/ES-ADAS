...
def main():
    ...
    # Dictionary to accumulate highest initial test fitness values for each benchmark
    ...
    for folder in os.listdir("."):
        ...
        # We only care about folders ending with "_MAPADAS"
        if folder.endswith("_MAPADAS"):
            # Extract the benchmark name by removing "_MAPADAS"
            bench_name = folder.replace("_MAPADAS", "")
            ...
            if bench_name in benchmarks:
                ...
                for file_name in os.listdir(folder_path):
                    if file_name.lower().endswith(".json"):
                        ...
                        if initial_entries:
                            # Parse test fitness values using the helper function
                            fitness_vals = [parse_fitness(e["test_fitness"]) for e in initial_entries]
    ...
    for bench in benchmarks:
        ...
        if fitness_values:
            ...
            print(f"  Mean Highest Initial Generation Test Fitness: {mean_val:.4f}")
